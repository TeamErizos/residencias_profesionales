...
$opcionProyecto = isset($_POST['OpcionProyecto']) ? $_POST['OpcionProyecto'] : '';

$sql = "SELECT * FROM Proyectos";

if (!empty($tipoProyecto)) {
  $sql .= " WHERE TipoProyecto = '$tipoProyecto'";
}

if (!empty($opcionProyecto)) {
  $sql .= " WHERE OpcionProyecto = '$opcionProyecto'";
}
...
<head>
  ...
  <title>Formulario de Registro y Vista de los Proyectos</title>
