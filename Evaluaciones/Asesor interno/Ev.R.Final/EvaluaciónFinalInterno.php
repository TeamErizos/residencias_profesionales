              ...
              <div class="containerForm">
                ...
                <div class="content">
                  <div class="input-box full-width">
                    ...
                    <input type="text" placeholder="Nombre del Asesor" name="NomRe" required>
                  </div>
                  ...
                  <div class="input-box full-width">
                    <label for="promedio">Calificación promedio</label>
                    <input type="text" placeholder="Promedio" name="promedio" required>
                  </div>
