      ...
      <main class="table slide-in">
        ...
        <section class="table__body slider-item" id="table1">
          ...
          <div class="containerForm">
            ...
            <form action="insertar_bd_p1E.php" method="post"><!--------------------------------------------------------------------->
          ...
          <div class="containerForm">
            ...
            <div class="content">
              <div class="containerForm">
                ...
                <div class="content">
                  <div class="input-box full-width">
                    <label for="IDAsesor" class="input-box full-width">Nombre</label>
                    <input type="text" placeholder="Nombre del Asesor" name="NomRe" value="<?php echo $resultados['nom_asesor_externo'], ' ', $resultados['ape1_asesor_externo'], ' ', $resultados['ape2_asesor_externo']; ?>" required>
                  </div>
